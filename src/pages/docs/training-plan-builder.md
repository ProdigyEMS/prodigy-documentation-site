...
{%figure src="/images/training-plans-to.png" alt="Training Plans tab showing published and draft plans" /%}
### Available Options
...
{%figure src="/images/add-plan.png" alt="Add Training Plan option in the Training Plan menu" /%}
### Add Training Plan
The first page brings up the basic options for the training plan.
{%figure src="/images/add-training-plan.png" alt="Add Training Plan form with name, description, and image fields" /%}
#### Training Plan Name
...
{%figure src="/images/requirement-groups.png" alt="Plan content section with a requirement group and Add Category option" /%}
### Requirement Groups
...
{%figure src="/images/requirement-categories.png" alt="Requirement category form with name, classes, and required hours" /%}
...
{%figure src="/images/finalize-plan.png" alt="Finish dialog with Assign and Skip options" /%}
## Editing Plan
...
{%figure src="/images/edit-plan.png" alt="View Training Plan link next to a published plan" /%}
...
{%figure src="/images/plan-edit-page.png" alt="Training plan edit page with details, groups, and assign options" /%}
