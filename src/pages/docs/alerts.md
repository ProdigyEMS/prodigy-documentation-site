...
3. **Select Additional Recipients** — choose any staff who should also receive this alert, such as training officers or others involved in training. This allows recipients to only get the alerts relevant to them. For example, your AHA coordinator can be set to only receive alerts for expiring AHA certifications.
4. **Also Notify the Expiring User** — this is checked by default and should generally stay on. For agency-managed certifications like fit tests, you may choose to notify only the responsible staff and leave the user out.
