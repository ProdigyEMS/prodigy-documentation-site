...
{%figure src="/images/access_org.png" alt="Department switcher in top right with Organization name selected" /%}
{%figure src="/images/admin_org.png" alt="Organization Admin section showing all departments in the organization" /%}
