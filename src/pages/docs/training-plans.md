...
{%figure src="/images/cardiac-arrest.png" alt="Cardiac Arrest category with multiple completed classes to choose from" /%}
...
{%figure src="/images/training-plan-tracking.png" alt="Training plan progress bars for overall, group, and distributive hours" /%}
### Customization
