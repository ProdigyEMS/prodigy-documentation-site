...
{%figure src="/images/edit-assignment.png" alt="Assignments table with pencil edit icons and export button" /%}
### Edit an Assignment
...
{%figure src="/images/delete-assignment.png" alt="Delete assignment option in the top right of the editor" /%}
