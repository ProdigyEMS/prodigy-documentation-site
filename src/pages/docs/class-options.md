...
{%figure src="/images/prodigy-classes.png" alt="Classes tab showing the Prodigy Classes catalog view" /%}
### Prodigy Classes
...
{%figure src="/images/delete-class.png" alt="Draft classes list with trashcan icon for deleting a draft" /%}
{%figure src="/images/active-class.png" alt="Published classes list with the Active toggle" /%}