...
{%figure src="/images/user-panel.png" alt="Users panel listing department members with roles and actions" /%}
### Invite users
{%figure src="/images/send-invite.png" caption="Access from Users->Invite New User" alt="Invite New User dialog with email address entry box" /%}
...
{%figure src="/images/assignments.jpeg" alt="Assignments tab listing existing class assignments" /%}
### Adding New Assignment
{%figure src="/images/add-assignment.jpeg" alt="Add Assignment form with class, due date, and user selection" /%}
...
{%figure src="/images/edit-assignment.png" alt="Assignments list with pencil edit icons and export option" /%}
### Edit an Assignment
...
{%figure src="/images/delete-assignment.png" alt="Assignment editor showing Delete Assignment button in top right" /%}
## Report on Assignments
{%figure src="/images/individual-assignments.png" alt="Individual Records list of assignments with filters and export" /%}
...
## Live Sessions
{%figure src="/images/add-live.png" alt="Add Live Session form for scheduling a class" /%}
...
{%figure src="/images/register-live.png" alt="Live class registration card showing session type and remaining seats" /%}
...
{%figure src="/images/in_person_live.png" alt="In-person live session options with date, start, end, and seats" /%}
### In-Person
...
{%figure src="/images/instructions.png" alt="In-person instructions text field for class location details" /%}
...
{%figure src="/images/complete-class.png" alt="Complete Class form with numbered steps for selecting session and users" /%}
...
{%figure src="/images/user-class-record.png" alt="User Class Record report with filters, columns, and export button" /%}
...
{%figure src="/images/date-picker.png" alt="Date picker with preset ranges for filtering report dates" /%}
